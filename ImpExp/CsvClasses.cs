...
namespace ImportExport
{
    ...
    {
        [Index(0)] public string BENCODE { get; set; }

        [Index(1)] public string CRM { get; set; }

        [Index(2)] public string CRM_email { get; set; }

        [Index(3)] public string emp_services { get; set; }

        [Index(4)] public string Primary_contact_name { get; set; }

        [Index(5)] public string Primary_contact_email { get; set; }

        [Index(6)] public string client_start_date { get; set; }
